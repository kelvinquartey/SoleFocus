...
export function renderOrderSummary(){
            ...
            <div class="cart-item-details-grid">
                ...
                <div class="cart-items-details">
                    ...
                    <div class="product-quantity
                        ...
                        <input type="number" class="quantity-input js-quantity-input-${matchingProduct.id}" min="1" max="999" inputmode="numeric">
    ...
    .forEach((element) => {
      element.addEventListener('click', () => {
        ...
        //const const deliveryOptionId} = element.dataset.deliveryOptionId;
